"""xltek_uuid_saturation_ops_table.py
...
# Definitions #
# Classes #
class BaseXLTEKUuidSaturationOpsTableSchema(BaseUpdateTableSchema):
    """A schema for a containing the UuidSaturationOps annotations in an XLTEK Study.
    ...
    # Class Attributes #
    __tablename__ = "uuid_SaturationOps"
    __mapper_args__ = {"polymorphic_identity": "uuid_SaturationOps"}
...
class XLTEKUuidSaturationOpsTableManifestation(UpdateTableManifestation):
    """The manifestation of a XLTEKUuidSaturationOpsTable.
