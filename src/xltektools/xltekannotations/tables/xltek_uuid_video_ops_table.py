...
# Definitions #
# Classes #
class BaseXLTEKUuidVideoOpsTableSchema(BaseUpdateTableSchema):
    """A schema for a containing the UuidVideoOps annotations in an XLTEK Study.
    ...
    # Class Attributes #
    __tablename__ = "uuid_video_ops"
    __mapper_args__ = {"polymorphic_identity": "uuid_video_ops"}
...
class XLTEKUuidVideoOpsTableManifestation(UpdateTableManifestation):
    """The manifestation of a XLTEKUuidVideoOpsTable.
