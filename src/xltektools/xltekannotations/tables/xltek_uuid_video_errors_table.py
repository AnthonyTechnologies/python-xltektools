...
# Definitions #
# Classes #
class BaseXLTEKUuidVideoErrorsTableSchema(BaseUpdateTableSchema):
    """A schema for a containing the UuidVideoErrors annotations in an XLTEK Study.
    ...
    # Class Attributes #
    __tablename__ = "uuid_video_errors"
    __mapper_args__ = {"polymorphic_identity": "uuid_video_errors"}
...
class XLTEKUuidVideoErrorsTableManifestation(UpdateTableManifestation):
    """The manifestation of a XLTEKUuidVideoErrorsTable.
