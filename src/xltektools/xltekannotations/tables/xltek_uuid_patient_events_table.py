"""xltek_uuid_patient_events_table.py
...
# Definitions #
# Classes #
class BaseXLTEKUuidPatientEventsTableSchema(BaseUpdateTableSchema):
    """A schema for a containing the UuidPatientEvents annotations in an XLTEK Study.
    ...
    # Class Attributes #
    __tablename__ = "uuid_patient_events"
    __mapper_args__ = {"polymorphic_identity": "uuid_patient_events"}
...
class XLTEKUuidPatientEventsTableManifestation(UpdateTableManifestation):
    """The manifestation of a XLTEKUuidPatientEventsTable.
